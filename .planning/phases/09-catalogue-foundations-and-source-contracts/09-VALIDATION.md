...
| 09-06-01 | 06 | 5 | REG-01, REG-02, REG-03, EVID-01, EVID-02 | T-09-22, T-09-23 | RED regressions prove public source/region validators reject malformed root and nested objects without throwing, and unverified coverage rejects own evidence/source URL fields. | unit | `pnpm --filter @scholar-scout/web run test -- __tests__/lib/catalogue-contract.test.ts --runInBand` | existing test file extended by this task | ✅ green |
| 09-06-02 | 06 | 5 | REG-01, REG-02, REG-03, EVID-01, EVID-02 | T-09-22 through T-09-24 | Public import guards and the runtime coverage discriminator preserve verified evidence rules, frozen six-region provenance, and all 36 explicit unknown cells. | unit + quality gate | `pnpm --filter @scholar-scout/web run test -- __tests__/lib/catalogue-contract.test.ts --runInBand && pnpm --filter @scholar-scout/web run test -- __tests__/lib/catalogue-fixtures.test.ts --runInBand && pnpm --filter @scholar-scout/web run typecheck && pnpm --filter @scholar-scout/web run lint && pnpm --filter @scholar-scout/web run test --runInBand` | existing contract and fixture suites | ✅ green |
...
- Plan 09-06 Task 1 adds CR-01/CR-02 malformed public-boundary and unverified-provenance RED regressions before Task 2 adds root/nested record guards and own-property coverage checks; Task 3 records the final repair map before the focused, fixture-preservation, typecheck, lint, and full-suite quality gate.

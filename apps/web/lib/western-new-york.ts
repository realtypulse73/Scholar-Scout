...
export const WESTERN_NEW_YORK_INSTITUTIONS: WesternNewYorkInstitution[] = [
  ...
  },
  {
    ...
    admissions: { testPolicy: 'verify-with-school', gpaGuidance: 'Ask admissions about placement, transcripts, GED/TASC pathways, and program prerequisites.', admissionsUrl: 'https://www.ecc.edu/admissions-and-aid/how-to-apply.html' },
    ...
    accountability: { notice: 'Review current Title IX, campus-safety, and student-support pages before applying.', sources: [{ label: 'Official admissions hub', url: 'https://www.ecc.edu/admissions-and-aid/index.html', status: 'review-before-applying' }] },
    sourceCheckedOn: '2026-08-29',
  },
  {
    id: 'trocaire',

...
export default function ReferralPanel({ referrer }: ReferralPanelProps) {
  ...
  return (
    <Card className="p-5">
      <h2 className="text-base font-semibold text-ink-900">Referral link</h2>
      ...
      {link ? (
        <p className="mt-3 break-all rounded-card border border-border bg-silver p-3 text-xs text-ink-600">
          {link}
        </p>
      ) : null}
    </Card>
